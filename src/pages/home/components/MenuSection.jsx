...
import { Calendar, Sun, CreditCard, RefreshCw, Timer } from 'lucide-react';
    ...
    <div className="mx-4 mt-6 relative z-20">
      ...
      <div className="grid grid-cols-2 gap-3.5">
        ...
        <button
          ...
          className="bg-white border border-slate-100 rounded-[22px] p-4 text-left shadow-[0_4px_16px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_24px_rgba(14,165,233,0.12)] hover:-translate-y-0.5 active:scale-[0.97] transition-all relative overflow-hidden flex flex-col justify-between min-h-[120px] group"
        >
          ...
          <div>
            <h4 className="text-[13.5px] font-black text-slate-800 group-hover:text-sky-600 transition-colors leading-tight">
              Lembur
            </h4>
            <span className="text-[10.5px] text-slate-400 font-medium block mt-0.5">
      ...
      {/* Update Progress — full width di paling bawah grid */}
      <button
        id="menu-progress-btn"
        onClick={() => onMenuClick('/produksi', 'Update Progress')}
        className="mt-3.5 w-full bg-white border border-slate-100 rounded-[22px] p-4 text-left shadow-[0_4px_16px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_24px_rgba(95,19,64,0.12)] hover:-translate-y-0.5 active:scale-[0.97] transition-all relative overflow-hidden flex items-center gap-4 min-h-[88px] group"
      >
