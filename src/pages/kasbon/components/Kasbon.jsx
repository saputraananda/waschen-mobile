                            ...
                            {item.type === 'pinjaman' && (
                              <>
                                ...
                                <div>
                                  ...
                                  <div className="text-[12px] font-bold text-slate-700">{Number(item.tenor_count) || Number(item.payment_count) || 0}x</div>
                                </div>
                              </>
                            )}
                          </div>
                                ...
                                <div key={p.id} className="flex items-start justify-between bg-white rounded-[8px] px-3 py-2 border border-indigo-100">
                                  <div className="min-w-0">
                                    <div className="text-[11.5px] font-bold text-slate-800">
                                      {item.type === 'pinjaman' && p.installment_no ? `Termin ${p.installment_no} · ` : ''}{formatRupiah(p.amount)}
                                    </div>
                                    ...
                                    {p.proof_url && (
                                      <a href={p.proof_url} target="_blank" rel="noreferrer" className="text-[10px] font-bold text-indigo-600">Bukti pembayaran</a>
                                    )}
                                  </div>
